...
import Guitaris from '../resources/img/guitaris.jpg';
// eslint-disable-next-line
import GuitarisSrcset from '../resources/img/guitaris.jpg?sizes=1200w+1000w+800w+600w+400w&placeholder';
  ...
  return (
    <GuestLayout>
      <div className="container p-t-xl  p-r-md p-l-md">
        ...
        <img alt="Cat & Dog Sleeping" src={Guitaris} />
        <hr />
        ...
        <Picture alt="Cat & Dog" image={GuitarisSrcset} />
      </div>
    </GuestLayout>
  );
};
